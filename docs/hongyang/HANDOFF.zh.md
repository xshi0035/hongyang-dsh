---
description: "弘阳开发交接历史记录，附当前实现状态入口。"
...
这是保留背景信息的 2026-09-11 历史快照。启动方式、分支、验收数字和未完成工作已变化；当前开发以 [2026-09-14 交接文档](CLAUDE_HANDOFF_2026-09-14.zh.md) 为准。下文删库、卸载和提交指令属于历史记录，不构成执行授权。

写给接手开发的人（或 Codex）。日期 2026-09-11 晚。演示日期 **2026-09-13**。

先按顺序读：本文 → [spec.md](spec.zh.md)（需求）→ [design.md](design.zh.md)（设计）→ `packages/hongyang/finance/README.md` → 跑一遍验收脚本（§7）。**先跑通、看懂，再改代码。**
