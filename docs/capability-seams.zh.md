...
flowchart LR
  ...
  svc_hyFinance["ctx.hyFinance<br/>Hongyang finance records"]
...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.hyFinance` | `core` | [`hy-finance`](../packages/hongyang/finance) | - | [`hy-dingtalk`](../packages/hongyang/dingtalk) | - | 持有财务数据库；内置工具、路由与钉钉桥接共享其导入、分配和报表操作。 |
