...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ConfirmResult: 'hongyang.md',
  DailyReport: 'hongyang.md',
  FinanceCounts: 'hongyang.md',
  HyFinanceConfig: 'hongyang.md',
  ImportKind: 'hongyang.md',
  ImportOutcome: 'hongyang.md',
  Merchant: 'hongyang.md',
  MerchantBalance: 'hongyang.md',
  OverdueRow: 'hongyang.md',
