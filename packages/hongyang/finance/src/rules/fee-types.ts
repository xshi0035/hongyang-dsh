...
export const FEE_RULES: Readonly<Record<FeeType, FeeRule>> = {
  ...
  water_post: { label: '后付水费', taxRate: 0.03, subject: '2203.31', subjectName: '预收账款_能源费_水费' },
  elec_post: { label: '后付电费', taxRate: 0.13, subject: '2203.30', subjectName: '预收账款_能源费_电费' },
  elec_pre: { label: '预付电费', taxRate: 0.13, subject: '2203.30', subjectName: '预收账款_能源费_电费' },
