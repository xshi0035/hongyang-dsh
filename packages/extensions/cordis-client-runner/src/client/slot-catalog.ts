...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'hy-finance FinanceSettingsCard',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, finance_claim, finance_daily_report, finance_voucher, glob, grep, present, read, read_image, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'hy-finance ClaimToolView key \'finance_claim\'',
      'hy-finance ReportToolView key \'finance_daily_report\'',
      'hy-finance VoucherToolView key \'finance_voucher\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
