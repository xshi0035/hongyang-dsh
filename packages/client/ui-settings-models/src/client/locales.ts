...
export const en = {
  ...
  welcomeBody: 'Hongyang Plaza AI Finance Assistant helps the finance and operations teams import bank statements, claim receipts, and produce the daily income report and vouchers. This is a demo build.',
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Add an API key to get started',
  onboardingDescription: 'Configure a model provider to start.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '欢迎使用',
  welcomeBody: '弘阳广场 AI 财务助手面向财务部与运营部：导入银行流水、认领收款、生成收入日报表和记账凭证。当前为演示版本。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '添加一个 API Key 开始使用',
  onboardingDescription: '配置模型服务后即可开始使用。',
